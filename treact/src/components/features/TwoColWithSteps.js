...
export default ({
  ...
  const defaultSteps = [
    {
      heading: "Register",
      description: "Create an account and claim your page."
    },
    {
      heading: "Share",
      description: "Upload your work and informe your readers about your page."
    },
    {
      heading: "Earn",
      description: "Receive donatinos from supports with no transaction fees."
    }
  ];
